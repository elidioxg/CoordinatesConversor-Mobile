package geocodigos.coordinateconversor;
...
import geocodigos.coordinateconversor.Conversion.CoordinateConversion;
import geocodigos.coordinateconversor.Conversion.DMSConversion;
import geocodigos.coordinateconversor.Conversion.ValidateConversion;
import geocodigos.coordinateconversor.Database.DatabaseHelper;
import geocodigos.coordinateconversor.Dialogs.DialogAddPoint;
import geocodigos.coordinateconversor.Fragments.MapView;
import geocodigos.coordinateconversor.Implementation.GetDate;
import geocodigos.coordinateconversor.Implementation.GetTime;
import geocodigos.coordinateconversor.Models.PointModel;
import geocodigos.coordinateconversor.Utils.CoordinatesArray;


/**
 * A placeholder fragment containing a simple view.
 */
public class ConvertCoordinatesFragment extends Fragment {
    ...
    public ConvertCoordinatesFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.convert_coordinates, container, false);
        ...
        ibPoints.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.fragment, mapView);
                ft.commit();
            }
        });
